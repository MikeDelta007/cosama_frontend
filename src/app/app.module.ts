...
import { VoyagePipe } from './infovoyage.pipe';
import { InfobateauPipe } from './infobateau.pipe';
import { Infovoyage2Pipe } from './infovoyage2.pipe';
...
import { GraduatedBarComponent } from './demo/view/graduated-bar/graduated-bar.component';
...
import { TypePiecePipe } from './type-piece.pipe';
import { TypePlacePipe } from './type-place.pipe';
import { InfoPlacePipe } from './info-place.pipe';
import { SexePipe } from './sexe.pipe';
import { Infovoyage3Pipe } from './infovoyage3.pipe';
import { Infovoyage4Pipe } from './infovoyage4.pipe';
import { Infovoyage5Pipe } from './infovoyage5.pipe';
...
@NgModule({
    ...
    declarations: [
        ...
        PlacesComponent,
        ProfilUserComponent,
        PointerVoyageComponent,
        TrackBilletComponent,
        DeblocagePlaceComponent,
        OpsBilletComponent,
        CustomCurrencyPipe,
        EditBilletComponent,
        PrintBilletComponent,
        CheckBilletComponent,
        CrudFretComponent,
        CrudComponent,
        ...
        EmbarkComponent,
        ManifesteComponent,
        ManifPassagersComponent,
        ManifFretTousComponent,
        ManifFretComponent,
        GraduatedBarComponent,
        SituComponent,
        MagasinageComponent,
        NationalityPipe,
        TypePiecePipe,
