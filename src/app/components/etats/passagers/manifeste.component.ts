...
import { RecapStatManifAdulte } from 'src/app/model/RecapStatManifAdulte.model';
...
@Component({
  ...
  styleUrls: ['./manifeste.component.scss']
})
export class ManifesteComponent implements OnInit {
  ...
  datarapportPax : any[] = [];
  recapManifAdulte : RecapStatManifAdulte[] = [];
  recapManifEnfant : RecapStatManifAdulte[] = [];
  dataFounds : any[] = [];
  dataFounds_ : any[] = [];
  dataFounds__ : any[] = [];
  ...
  printManifeste() {
    ...
    getManifeste() 
    {
        ...
        this.etatService.getManifesteAdulte(this.selectedVoyage, batId).subscribe((response:any) => 
        {
        ...
        this.etatService.getRecapManifesteAdulte(this.selectedVoyage, batId).subscribe((response:any) => 
        {
                this.recapManifAdulte = response;
                console.log(this.recapManifAdulte);
        }
        );  
    ...
    get totalAdultes(): number {
        return this.recapManifAdulte.reduce((sum, p) => sum + p.nb_adultes, 0);
      }
      
      get totalCaravanes(): number {
        return this.recapManifAdulte.reduce((sum, p) => sum + p.nb_escale, 0);
      }
      
      get totalHommes(): number {
        return this.recapManifAdulte.reduce((sum, p) => sum + p.nb_hommes, 0);
      }
      
      get totalFemmes(): number {
        return this.recapManifAdulte.reduce((sum, p) => sum + p.nb_femmes, 0);
      }
      
      get totalPlaces(): number {
        return this.recapManifAdulte.reduce((sum, p) => sum + p.nb_total_passagers, 0);
      }

      

      ///
      get totalAdultes_(): number {
        return this.recapManifEnfant.reduce((sum, p) => sum + p.nb_adultes, 0);
      }
      
      get totalCaravanes_(): number {
        return this.recapManifEnfant.reduce((sum, p) => sum + p.nb_escale, 0);
      }
      
      get totalHommes_(): number {
        return this.recapManifEnfant.reduce((sum, p) => sum + p.nb_hommes, 0);
      }
      
      get totalFemmes_(): number {
        return this.recapManifEnfant.reduce((sum, p) => sum + p.nb_femmes, 0);
      }
      
      get totalPlaces_(): number {
        return this.recapManifEnfant.reduce((sum, p) => sum + p.nb_total_passagers, 0);
      }
    ...
    getManifeste2() 
    {
        ...
        this.etatService.getManifesteEnfant(this.selectedVoyage2, batId).subscribe((response:any) => 
        {
        ...
        this.etatService.getRecapManifesteEnfant(this.selectedVoyage2, batId).subscribe((response:any) => 
            {
                    this.recapManifEnfant = response;
                    console.log(this.recapManifEnfant);
            }
        );  
    }
    ...
    getManifeste3()
    {
        ...
        this.etatService.getManifesteBebe(this.selectedVoyage3, batId).subscribe((response:any) => 
        {
    ...
    getManifeste4()
    {
        ...
        this.etatService.getManifestePNE(this.selectedVoyage4, batId).subscribe((response:any) => 
            {
    ...
    getManifeste5()
    {
        ...
        this.etatService.getBilletsReportes(this.selectedVoyage5, batId).subscribe((response:any) => 
            {
    ...
    getManifeste6()
    {
        ...
        this.etatService.getRapportPAX(this.selectedVoyage6, batId).subscribe((response:any) => 
            {
